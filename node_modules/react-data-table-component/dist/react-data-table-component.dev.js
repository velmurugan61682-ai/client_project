...
const TableStyle = styled__default["default"].div `
	...
	${({ theme }) => { var _a; return (_a = theme.table) === null || _a === void 0 ? void 0 : _a.style; }};
`;
...
const Head = styled__default["default"].div `
	...
	${({ theme }) => { var _a; return (_a = theme.head) === null || _a === void 0 ? void 0 : _a.style; }};
`;
...
const HeadRow = styled__default["default"].div `
	...
	align-items: stretch;
	width: 100%;
	${({ theme }) => { var _a; return (_a = theme.headRow) === null || _a === void 0 ? void 0 : _a.style; }};
	${({ $dense, theme }) => { var _a; return $dense && ((_a = theme.headRow) === null || _a === void 0 ? void 0 : _a.denseStyle); }};
`;
...
const CellBase = styled__default["default"].div `
	...
	box-sizing: border-box;
	line-height: normal;
	${({ theme, $headCell }) => { var _a; return (_a = theme[$headCell ? 'headCells' : 'cells']) === null || _a === void 0 ? void 0 : _a.style; }};
...
const CellStyle = styled__default["default"](CellExtended).attrs(props => ({
	...
	${({ theme, $isDragging }) => { var _a; return $isDragging && ((_a = theme.cells) === null || _a === void 0 ? void 0 : _a.draggingStyle); }};
	${({ $cellStyle }) => $cellStyle};
`;
...
function areCellPropsEqual(prevProps, nextProps) {
...
var TableCell = React__namespace.memo(Cell, areCellPropsEqual);
...
const ButtonStyle = styled__default["default"].button `
	...
	${({ theme }) => { var _a; return (_a = theme.expanderButton) === null || _a === void 0 ? void 0 : _a.style; }};
`;
...
const CellExpanderStyle = styled__default["default"](CellBase) `
	...
	font-weight: 400;
	min-width: 48px;
	${({ theme }) => { var _a; return (_a = theme.expanderCell) === null || _a === void 0 ? void 0 : _a.style; }};
`;
...
const ExpanderRowStyle = styled__default["default"].div `
	width: 100%;
	box-sizing: border-box;
	${({ theme }) => { var _a; return (_a = theme.expanderRow) === null || _a === void 0 ? void 0 : _a.style; }};
...
const highlightCSS = styled.css `
	&:hover {
		${({ $highlightOnHover, theme }) => { var _a; return $highlightOnHover && ((_a = theme.rows) === null || _a === void 0 ? void 0 : _a.highlightOnHoverStyle); }};
	}
`;
...
const TableRowStyle = styled__default["default"].div.attrs(props => ({
	...
	width: 100%;
	box-sizing: border-box;
	${({ theme }) => { var _a; return (_a = theme.rows) === null || _a === void 0 ? void 0 : _a.style; }};
	${({ $dense, theme }) => { var _a; return $dense && ((_a = theme.rows) === null || _a === void 0 ? void 0 : _a.denseStyle); }};
	${({ $striped, theme }) => { var _a; return $striped && ((_a = theme.rows) === null || _a === void 0 ? void 0 : _a.stripedStyle); }};
	${({ $highlightOnHover }) => $highlightOnHover && highlightCSS};
	${({ $pointerOnHover }) => $pointerOnHover && pointerCSS};
	${({ $selected, theme }) => { var _a; return $selected && ((_a = theme.rows) === null || _a === void 0 ? void 0 : _a.selectedHighlightStyle); }};
...
function Row({ columns = [], conditionalRowStyles = [], defaultExpanded = false, defaultExpanderDisabled = false, dense = false, expandableIcon, expandableRows = false, expandableRowsComponent, expandableRowsComponentProps, expandableRowsHideExpander, expandOnRowClicked = false, expandOnRowDoubleClicked = false, highlightOnHover = false, id, expandableInheritConditionalStyles, keyField, onRowClicked = noop, onRowDoubleClicked = noop, onRowMouseEnter = noop, onRowMouseLeave = noop, onRowExpandToggled = noop, onSelectedRow = noop, pointerOnHover = false, row, rowCount, rowIndex, selectableRowDisabled = null, selectableRows = false, selectableRowsComponent, selectableRowsComponentProps, selectableRowsHighlight = false, selectableRowsSingle = false, selected, striped = false, draggingColumnId, onDragStart, onDragOver, onDragEnd, onDragEnter, onDragLeave, }) {
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null,
        React__namespace.createElement(TableRowStyle, { id: `row-${id}`, role: "row", "$striped": isStriped, "$highlightOnHover": highlightOnHover, "$pointerOnHover": !defaultExpanderDisabled && showPointer, "$dense": dense, onClick: handleRowClick, onDoubleClick: handleRowDoubleClick, onMouseEnter: handleRowMouseEnter, onMouseLeave: handleRowMouseLeave, className: classNames, "$selected": highlightSelected, "$conditionalStyle": conditionalStyle },
            ...
            expandableRows && !expandableRowsHideExpander && (React__namespace.createElement(CellExpander, { id: rowKeyField, expandableIcon: expandableIcon, expanded: expanded, row: row, onToggled: handleExpanded, disabled: defaultExpanderDisabled })),
            columns.map(column => {
                if (column.omit) {
                    return null;
                }
...
var Row$1 = React__namespace.memo(Row, areRowPropsEqual);
...
const ColumnStyled = styled__default["default"](CellExtended) `
	...
	${({ theme, $isDragging }) => { var _a; return $isDragging && ((_a = theme.headCells) === null || _a === void 0 ? void 0 : _a.draggingStyle); }};
`;
...
function areColPropsEqual(prevProps, nextProps) {
    if (prevProps.column !== nextProps.column) {
        return false;
    }
...
var Column = React__namespace.memo(TableCol, areColPropsEqual);
...
const Title$1 = styled__default["default"].div `
	...
	flex: 1 0 auto;
	height: 100%;
	color: ${({ theme }) => { var _a; return (_a = theme.contextMenu) === null || _a === void 0 ? void 0 : _a.fontColor; }};
	font-size: ${({ theme }) => { var _a; return (_a = theme.contextMenu) === null || _a === void 0 ? void 0 : _a.fontSize; }};
	font-weight: 400;
`;
...
const ContextMenuStyle = styled__default["default"].div `
	...
	${({ theme }) => { var _a; return (_a = theme.contextMenu) === null || _a === void 0 ? void 0 : _a.style; }};
	${({ theme, $visible }) => { var _a; return $visible && ((_a = theme.contextMenu) === null || _a === void 0 ? void 0 : _a.activeStyle); }};
`;
...
const HeaderStyle = styled__default["default"].div `
	...
	width: 100%;
	flex-wrap: wrap;
	${({ theme }) => { var _a; return (_a = theme.header) === null || _a === void 0 ? void 0 : _a.style; }}
`;
const Title = styled__default["default"].div `
	flex: 1 0 auto;
	color: ${({ theme }) => { var _a; return (_a = theme.header) === null || _a === void 0 ? void 0 : _a.fontColor; }};
	font-size: ${({ theme }) => { var _a; return (_a = theme.header) === null || _a === void 0 ? void 0 : _a.fontSize; }};
	font-weight: 400;
`;
...
const SubheaderWrapper = styled__default["default"].header `
	...
	${({ theme }) => { var _a; return (_a = theme.subHeader) === null || _a === void 0 ? void 0 : _a.style; }}
`;
const Subheader = (_a) => {
...
const ResponsiveWrapper = styled__default["default"].div `
	...
	${({ theme }) => { var _a; return (_a = theme.responsiveWrapper) === null || _a === void 0 ? void 0 : _a.style; }};
`;
...
const ProgressWrapper = styled__default["default"].div `
	...
	width: 100%;
	height: 100%;
	${props => { var _a; return (_a = props.theme.progress) === null || _a === void 0 ? void 0 : _a.style; }};
`;

const Wrapper = styled__default["default"].div `
	position: relative;
	width: 100%;
	${({ theme }) => { var _a; return (_a = theme.tableWrapper) === null || _a === void 0 ? void 0 : _a.style; }};
`;
...
const NoDataWrapper = styled__default["default"].div `
	...
	width: 100%;
	height: 100%;
	${({ theme }) => { var _a; return (_a = theme.noData) === null || _a === void 0 ? void 0 : _a.style; }};
`;
...
const PaginationWrapper = styled__default["default"].nav `
	...
	padding-left: 8px;
	width: 100%;
	${({ theme }) => { var _a; return (_a = theme.pagination) === null || _a === void 0 ? void 0 : _a.style; }};
`;
const Button = styled__default["default"].button `
	...
	user-select: none;
	border: none;
	${({ theme }) => { var _a; return (_a = theme.pagination) === null || _a === void 0 ? void 0 : _a.pageButtonsStyle; }};
...
function useTableState(props) {
    const { data, keyField, defaultSortColumn, defaultSortDirection, paginationDefaultPage, paginationPerPage, paginationServer, paginationServerOptions, paginationTotalRows, pagination, selectableRowsSingle, selectableRowsVisibleOnly, selectableRowSelected, clearSelectedRows, paginationResetDefaultPage, onSelectedRowsChange, onSort, onChangePage, onChangeRowsPerPage, } = props;
    const { persistSelectedOnSort = false, persistSelectedOnPageChange = false } = paginationServerOptions;
    const mergeSelections = paginationServer && (persistSelectedOnPageChange || persistSelectedOnSort);
    const [tableState, dispatch] = React__namespace.useReducer(tableReducer, {
        allSelected: false,
        selectedCount: 0,
        selectedRows: [],
    ...
    const handleChangeRowsPerPage = React__namespace.useCallback((newRowsPerPage, tableRowsLength) => {
    ...
    const sortCallbackRef = React__namespace.useRef(onSort);
...
function useTableData(props) {
    const { data, selectedColumn, sortDirection, currentPage, rowsPerPage, pagination, paginationServer, sortServer, sortFunction, onSort, } = props;
    ...
    const sortCallbackRef = React__namespace.useRef(onSort);
    const prevSortRef = React__namespace.useRef({ selectedColumn, sortDirection });
    React__namespace.useEffect(() => {
        sortCallbackRef.current = onSort;
    }, [onSort]);
    React__namespace.useEffect(() => {
...
function DataTable(props) {
    ...
    const { tableState, handleSort, handleSelectAllRows, handleSelectedRow, handleChangePage: handleChangePageState, handleChangeRowsPerPage: handleChangeRowsPerPageState, } = useTableState({
        data,
        keyField,
        defaultSortColumn,
        defaultSortDirection,
    ...
    const { rowsPerPage, currentPage, selectedRows, allSelected, selectedCount, selectedColumn, sortDirection, } = tableState;
    ...
    const handleChangePage = React__namespace.useCallback((page) => handleChangePageState(page), [handleChangePageState]);
    const handleChangeRowsPerPage = React__namespace.useCallback((newRowsPerPage) => handleChangeRowsPerPageState(newRowsPerPage, tableRows.length), [handleChangeRowsPerPageState, tableRows.length]);
    const showTableHead = () => {
        if (noTableHead) {
            return false;
        }
    ...
    return (React__namespace.createElement(styled.ThemeProvider, { theme: currentTheme },
        ...
        React__namespace.createElement(ResponsiveWrapper, Object.assign({ "$responsive": responsive, "$fixedHeader": fixedHeader, "$fixedHeaderScrollHeight": fixedHeaderScrollHeight, className: className }, wrapperProps),
            React__namespace.createElement(Wrapper, null,
                ...
                React__namespace.createElement(TableStyle, Object.assign({ disabled: disabled, className: "rdt_Table", role: "table" }, (ariaLabel && { 'aria-label': ariaLabel })),
